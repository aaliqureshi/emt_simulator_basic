...
fac = 0.1
sys.models.line.X[line] = 1e10 * fac
sys.models.line.R[line] = 1e10 * fac
...
p = (address, sys.models, sys.incidence_matrix, sys.C_eq, sys.non_slack_buses, lambda)
tstops = []
prob5 = MyDiffEq.ODEProblem(solve_dynamic_sim!, u1_new, (0.0, 1.1), p, mass_matrix)
sol5 = MyDiffEq.Solve(prob5, 1e-4, method=:Euler, adaptive=false, tstops=tstops)
